      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-600">Edit the event details below</p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <input
                  type="text"
                  id="title"
                  {...register("title", { required: "English title is required" })}
              ...
              {/* Title Bangla */}
              <div className="sm:col-span-2">
                <label htmlFor="titleBangla" className="block text-sm font-medium text-gray-700">
                  Title (Bangla) <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  id="titleBangla"
                  {...register("titleBangla", { required: "Bangla title is required" })}
                  className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ${errors.titleBangla ? 'border-red-500' : 'border'}`}
                />
                {errors.titleBangla && <p className="mt-1 text-sm text-red-600">{errors.titleBangla.message}</p>}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ${errors.eventDate ? 'border-red-500' : 'border'}`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  {...register("registrationStartDate", { 
                    ...
                    validate: value => {
                      if (watchEndDate && new Date(value) > new Date(watchEndDate)) {
                        return "Start date must be before end date";
                      }
                      return true;
                    }
                  })}
                  className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ${errors.registrationStartDate ? 'border-red-500' : 'border'}`}
                />
                {errors.registrationStartDate && (
                  <p className="mt-1 text-sm text-red-600">{errors.registrationStartDate.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm ${errors.registrationEndDate ? 'border-red-500' : 'border'}`}
                />
                {errors.registrationEndDate && (
                  <p className="mt-1 text-sm text-red-600">{errors.registrationEndDate.message}</p>
                )}
              </div>
            </div>
