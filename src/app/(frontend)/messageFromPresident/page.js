...
export async function generateMetadata() {
  ...
  return {
    title: "সভাপতির বাণী",
    description: presidentMessage.message,
  };
}
...
export default async function BackgroundPage() {
  ...
  const { vision, mission, achievements, presidentMessage } = data;
    ...
    <div className="bg-white/40 backdrop-blur-[2px] rounded-2xl shadow-xl overflow-hidden">
      ...
      >
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-white text-center px-4">
          <h1 className="text-2xl md:text-3xl font-bold mb-4">সভাপতির বাণী</h1>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="md:w-1/3 flex flex-col items-center">
              <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-lg mb-4">
                <img
                  src={presidentMessage.image.url}
