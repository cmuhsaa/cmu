            ...
            <div key={event._id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="p-6">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-xl font-bold text-gray-800">
                      {event.title} 
                      {event.titleBangla && (
                        <span className="block text-lg font-normal text-gray-600 mt-1">({event.titleBangla})</span>
                      )}
                    </h3>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-gray-700">
                        Registration: {event.registrationStartDate} to {event.registrationEndDate}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between mt-6 text-sm text-gray-500">
                  <span>Created: {event.createDate?.date} {event.createDate?.formatedTime}</span>
                  <span>Updated: {event.updateDate?.date} {event.updateDate?.formatedTime}</span>
                </div>
              </div>
            </div>
          ))}
